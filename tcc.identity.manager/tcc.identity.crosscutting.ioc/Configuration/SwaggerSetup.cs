    ...
    public static class SwaggerSetup
    {
        public static void AddSwaggerSetup(this IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(s =>
            {
                ...
                {
                    Version = "v1",
                    Title = "TCC Identity Management",
                    Description = "API Gerenciadora da  de usuários",
                    Contact = new OpenApiContact { Name = "Raphael", Email = "raphael@sga.pucminas.br" }
                });
        ...
        public static void UseSwaggerSetup(this IApplicationBuilder app)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "TCC Identity Management");
            });
        }
    }
